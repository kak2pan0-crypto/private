...
Использовать как локальный сайт
Можно просто скачать себе архив или эту папку с сетевого диска. <br>
Все статьи написаны в Markdown — удобно просматривать в [VSCode](https://code.visualstudio.com/)
...
<ol start="13">
  ...
  <li><a href="12_permissions">Управление правами доступа (chmod, chown, umask, ACL)</a></li>
    <li><a href="unlock_admin_astra">Разблокировка администратора Astra</a></li>
</ol>
